...
@section('section')
<form action="/player-data/{{ $player->slug }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-lg-6">
                            ...
                            <div class="col-xl-12">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-12">
                                            @if ($player->akte)
                                                <iframe src="{{ asset('storage/'. $player->akte) }}" id="previewFrame" width="400" height="300" class="mt-3"></iframe>
                                            @else
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-12">
                                            @if ($player->kk)
                                                <iframe src="{{ asset('storage/'. $player->kk) }}" id="second_previewFrame" width="400" height="300" class="mt-3"></iframe>
                                            @else
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-12">
                                            @if ($player->photo_nisn)
                                                <iframe src="{{ asset('storage/'. $player->photo_nisn) }}" id="third_previewFrame" width="400" height="300" class="mt-3"></iframe>
                                            @else
