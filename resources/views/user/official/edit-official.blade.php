        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form action="/official-data/{{ $official->slug }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-xl-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-12">
                                            @if ($official->licence_photo)
                                                <img src="{{ asset('storage/'. $official->licence_photo) }}" class="second_img-preview img-fluid mt-3 col-sm-5" />
                                            @endif
                                        </div>
                                    </div>
                                </div>
